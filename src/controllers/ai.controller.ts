...
export const generateAiKeywords = async (req: Request, res: Response) => {
...
export const generateAiSchema = async (req: Request, res: Response) => {
...
export const generateAiAnalysis = async (req: Request, res: Response) => {
  ...
  if (!data) return res.status(400).json({ error: 'Dashboard data is required' });
...
export const generateAiChat = async (req: Request, res: Response) => {
