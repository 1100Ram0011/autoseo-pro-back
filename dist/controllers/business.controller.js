...
exports.generateReviewReply = exports.getReviews = exports.publishPost = exports.generateDailyPost = exports.getBusinessProfile = exports.connectBusiness = void 0;
const genai_1 = require("@google/genai");
// Mock OAuth logic for the MVP
const connectBusiness = async (req, res) => {
...
exports.connectBusiness = connectBusiness;
...
const generateDailyPost = async (req, res) => {
...
const generateReviewReply = async (req, res) => {
    const apiKey = process.env.GEMINI_API_KEY;
    if (!apiKey)
        return res.status(500).json({ error: 'GEMINI_API_KEY is missing' });
...
exports.generateReviewReply = generateReviewReply;
