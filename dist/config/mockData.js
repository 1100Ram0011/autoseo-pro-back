...
exports.generateMockClarityData = exports.MOCK_AI = exports.generateMockPageSpeed = exports.MOCK_GA4 = exports.MOCK_GSC = exports.isGoogleConnected = exports.isMockMode = void 0;
// --- Environment Check ---
const isMockMode = () => {
    return !process.env.GEMINI_API_KEY || process.env.GEMINI_API_KEY === 'MOCK_KEY';
};
exports.isMockMode = isMockMode;
const isGoogleConnected = (refreshToken) => {
    return !!refreshToken;
};
...
// --- PageSpeed Mock Data ---
const generateMockPageSpeed = (url, strategy) => ({
    strategy,
    url,
...
exports.generateMockPageSpeed = generateMockPageSpeed;
// --- AI Mock Data ---
exports.MOCK_AI = {
    analysis: (siteUrl) => ({
...
// --- Clarity Mock Data ---
const generateMockClarityData = (siteUrl) => {
...
exports.generateMockClarityData = generateMockClarityData;
