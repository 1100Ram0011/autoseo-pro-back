...
exports.AutonomousLocalBusinessCloser = void 0;
const googleapis_1 = require("googleapis");
class AutonomousLocalBusinessCloser {
    // Step 1: Data Extraction
    async extractData(location, industry) {
    ...
    async runLiveAudit(url) {
        ...
        try {
            const pagespeed = googleapis_1.google.pagespeedonline('v5');
    ...
    async generateDynamicPDF(lead, auditData) {
    ...
    async autonomousOutreach(lead, pdfBuffer, auditData) {
    ...
    // Orchestrator
    async executePipeline(location, industry) {
...
exports.AutonomousLocalBusinessCloser = AutonomousLocalBusinessCloser;
