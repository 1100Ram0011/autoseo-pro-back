...
exports.AiTrendJacker = void 0;
const genai_1 = require("@google/genai");
const prisma_1 = __importDefault(require("../config/prisma"));
class AiTrendJacker {
    ai;
    constructor() {
        this.ai = new genai_1.GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY || 'MOCK_KEY' });
    }
    // 1. Trend Scanning
    async scanTrends() {
    ...
    async dispatchContent(siteId, contentData) {
...
exports.AiTrendJacker = AiTrendJacker;
//# sourceMappingURL=trendJacker.js.map